(function () {
    ...
    setTimeout(() => {
      try {
        ...
        canvas.toBlob(blob => {
          ...
          28tools.showStatus('statusArea', 'success', 'Adjustments applied! Click Download to save.');
        }, fmt, 0.92);
      } catch (e) {
  ...
  downloadBtn.addEventListener('click', () => {
    if (resultBlob) {
      ...
      28tools.downloadBlob(resultBlob, `${base}-adjusted.${ext}`);
    }
  });
  ...
  function loadImage(file) {
    ...
    img.onload = () => {
      ...
      resultBlob = null;
      28tools.showStatus('statusArea', 'success', 'Image loaded. Adjust sliders and click Apply.');
    };
    img.src = url;
  }
