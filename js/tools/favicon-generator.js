(function(){
  ...
  downloadBtn.addEventListener('click',async()=>{
    ...
    script.onload=async()=>{
      ...
      28tools.downloadBlob(zb,'favicons.zip');
  ...
  function loadImage(file){
    ...
    img=new Image();
    img.onload=()=>{ previewBody.innerHTML=`<img src="${url}" class="preview-img" alt="Source" style="max-height:200px">`; sizeInfo.textContent=`${img.naturalWidth}×${img.naturalHeight} | ${28tools.formatBytes(file.size)}`; workspace.style.display=''; };
    img.src=url;
  }
