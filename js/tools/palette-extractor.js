(function () {
  ...
  function extractPalette() {
    if (!img) return;
    28tools.showStatus('statusArea', 'info', 'Analyzing image colors…');
    ...
    setTimeout(() => {
      try {
        ...
        28tools.showStatus('statusArea', 'success', `Extracted ${palette.length} dominant colors!`);
      } catch (e) {
  ...
  function loadImage(file) {
    ...
    img.onload = () => {
      ...
      paletteArea.innerHTML = '';
      28tools.showStatus('statusArea', 'success', 'Image loaded. Click Extract Palette.');
    };
    img.src = url;
  }
