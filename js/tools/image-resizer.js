(function(){
  ...
  function loadFile(file){
    ...
    origImg.onload=()=>{
      ...
      sizeInfo.textContent=`Original: ${origW}×${origH} | ${ToolsApp.formatBytes(file.size)}`;
  ...
  resizeBtn.addEventListener('click',()=>{
    ...
    canvas.toBlob(blob=>{
      ...
      sizeInfo.textContent=`Resized: ${tw}×${th} | ${ToolsApp.formatBytes(blob.size)}`;
  ...
  downloadBtn.addEventListener('click',()=>{
    ...
    ToolsApp.downloadBlob(resultBlob,`${base}-resized.${ext}`);
  });
