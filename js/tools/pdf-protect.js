(function(){
  ...
  function loadFile(file){
    currentFile=file;
    previewBody.innerHTML=`<div class="status-msg status-msg--success">✅ PDF ready: ${28tools.formatBytes(file.size)}</div>`;
    sizeInfo.textContent=28tools.formatBytes(file.size);
  ...
  downloadBtn.addEventListener('click',()=>{ if(window._protectedPdf) 28tools.downloadBlob(window._protectedPdf,'protected.pdf'); });
