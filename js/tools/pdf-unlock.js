(function(){
  ...
  processBtn.addEventListener('click',async()=>{
    ...
    s.onload=async()=>{
      try{
        ...
        sizeInfo.textContent=`${doc.getPageCount()} pages | ${28tools.formatBytes(blob.size)}`;
  ...
  downloadBtn.addEventListener('click',()=>{ if(window._unlockedPdf) 28tools.downloadBlob(window._unlockedPdf,'unlocked.pdf'); });
