(function(){
  ...
  function loadFile(file){
    ...
    s.onload=async()=>{
      ...
      <p><strong>Size:</strong> ${ToolsApp.formatBytes(file.size)}</p>
      ...
      sizeInfo.textContent=`${doc.getPageCount()} pages | ${ToolsApp.formatBytes(file.size)}`;
  ...
  downloadBtn.addEventListener('click',()=>{ if(window._metaPdf) ToolsApp.downloadBlob(window._metaPdf,'metadata-edited.pdf'); });
