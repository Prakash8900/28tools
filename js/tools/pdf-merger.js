(function(){
  ...
  processBtn.addEventListener('click',async()=>{
    ...
    s.onload=async()=>{
      ...
      sizeInfo.textContent=`Merged: ${total} pages | ${ToolsApp.formatBytes(blob.size)}`;
  ...
  downloadBtn.addEventListener('click',()=>{ if(window._mergedPdf) ToolsApp.downloadBlob(window._mergedPdf,'merged.pdf'); });
